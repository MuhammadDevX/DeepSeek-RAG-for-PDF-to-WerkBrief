...
export const WerkbriefSchema = z.object({
  fields: z.array(z.object({
    ...
    "GOEDEREN OMSCHRIJVING": z.string({ description: "Description of the product goods in Dutch based from the knowledgebase" }),
    "GOEDEREN CODE": z.string({ description: "Code for that product mentioned from the knowledgebase" }),
