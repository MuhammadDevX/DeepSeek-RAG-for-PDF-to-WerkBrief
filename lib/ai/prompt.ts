...
- The number of item prices mentioned in an invoice reflect the total number of products in that invoice. e.g., if there are 5 item prices mentioned, there should be 5 products listed.
`;
